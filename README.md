...
- Make sure your Ethereum wallet is connected to the local Hardhat network.
- The `artifacts` directory is generated after compiling contracts.
- For production, consider deploying contracts to a public testnet or mainnet.
...
Created by [AdamSonja](https://github.com/AdamSonja)  
